...
- 2 Effects:
	- Counts as a success
		- success effect can be Cancelled by fail
	- Triggers effects
		- Critical injury on attack
...
- occur regardless of success
	- dont impact success or failure
- Cancels advantage
...
---
---
# 31 Interpreting the Pool
---
## Success/Fail
- Each fail cancels out a success
- need at least 1 success to succeed
- triumph/despair counts as success/fail
## Advantage/Threat
- threat cancels advantage
- only affects when one outnumbers the other
- player chooses how to use advantage
	- using weapon quality, maneuver, recover strain
- Threat are by GM
	- suffer strain, provide opportunity to opponent, falling prone, environmental, taking longer
## Triumph/Despair
- does not cancel out
- both results interpret separately
- more powerful version of advantage/threat
...
- unskilled assistance: if no higher stats.. GM may add 1 boost die
...
- when you spend 1 point, it flips to the opposite
	- flip occurs after the action is used to stop immediate countering
- can only spend 1 DP/action
- can enhance skill check, upgrade ability into proficiency
- can increase NPC skill check difficulty
#### Narrative usage
- can used to state a "fact" into the narrative
	- land on planet without atmosphere but have no rebreathers.  Can spend a DP to state "Good thing you remembered to pack those rebreathers"
	- if GM agrees it is a good addition, it is added
	- may find spare items, introduce cover nearby
- GM has final say
- players should not be outrageous.
- DP usage meant to reward creativity and roleplay
### Economy in gameplay
- locking points is against the system.  They are meant to be used
- often remind them about destiny points, use if feeling outmatched
### Limits of Luck
- a player/GM can each use 1 DP per check
...
- used during character creation as a currency
- any unspent points can be saved for later
...
## Acquiring Talents
- May purchase using XP via talent tree
## Acquiring Specializations
- Each character starts with 1 specialization
- may purchase as many additional specializations as they want
- gains benefits of new specializations career skills
- Can purchase specializations from any career
	- price of career specializations = 10 * total # of specializations after purchase
...
## Soak Value
- How much damage they can shrug off before taking real damage
- SV is subtracted from damage, remaining damage applies wounds to character
- default SV = Brawn
- Increasing brawn increases SV
- gained by armor, talents & increasing brawn
